...
module.exports = {
    name: "lookup",
    description: "Returns on the given field",
    slash: true,
    guildOnly: true,
    category: 'Misc',
    options: [
            ...
            switch (options.getSubcommand()) {
                ...
                case "user": {
                    ...
                    .addFields({
                        ...
                        **\`•\` Joined Server**: <t:${parseInt(Target.joinedTimestamp / 1000)}> (<t:${parseInt(Target.joinedTimestamp / 1000)}:R>)
                        **\`•\` Joined Discord**: <t:${parseInt(Target.user.createdTimestamp / 1000)}> (<t:${parseInt(Target.user.createdTimestamp / 1000)}:R>)
                        ㅤ
                        `,
                        inline: false,
                    })
                    ...
                    .addFields(
                        {
                            ...
                            **\`•\` Name**: ${guild.name}
                            **\`•\` ID**: ${guild.id}
                            **\`•\` Created**: <t:${parseInt(guild.createdTimestamp / 1000)}> (<t:${parseInt(guild.createdTimestamp / 1000)}:R>)
                            **\`•\` Owner**: <@${guild.ownerId}>
                ...
                case "channel": {
                    ...
                    if (channel.type !== "GUILD_VOICE") {
                        ...
                        const msgs = await channel.messages.fetch({ limit: 100 }).then((res) => { return res });
                        const now = Date.now();
                        ...
                        .addFields({
                            ...
                            **\`•\` Created**: <t:${parseInt(channel.createdTimestamp / 1000)}> (<t:${parseInt(channel.createdTimestamp / 1000)}:R>)
                            ㅤ
                            `
                        }, {
                            name: "THREADS: ",
